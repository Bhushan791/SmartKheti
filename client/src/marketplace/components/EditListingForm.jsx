...
const EnhancedEditListingForm = ({ listing, onSubmit, onClose }) => {
  ...
  useEffect(() => {
    if (listing) {
      setFormData({
        ...
        optional_contact: listing.optional_contact || "",
        images: [], // New images to be uploaded
        video: null, // New video to be uploaded
      })
      ...
      if (listing.video) {
        setExistingVideo(listing.video)
      }
    }
  }, [listing])
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      // Pass existing images/video and new files to onSubmit
      await onSubmit({ ...formData, existingImages, existingVideo })
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-100">Update your crop information</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6 lg:p-8 space-y-8">
            ...
            {(existingImages.length > 0 || existingVideo) && (
              <div className="bg-purple-50 p-6 rounded-2xl">
                      ...
                      {existingImages.map((image, index) => (
                        <div key={index} className="relative group">
                          <img
                            ...
                            alt={`Current ${index + 1}`}
                            className="w-full h-24 object-cover rounded-xl border-2 border-gray-200 group-hover:border-purple-400 transition-colors duration-200"
                          />
                          <button
                            type="button"
                ...
                {existingVideo && (
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-3">Current Video</label>
                    <div className="relative">
                      <video
                        src={existingVideo}
                        controls
            ...
            <div className="bg-amber-50 p-6 rounded-2xl">
              ...
              <div className="mb-6">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-green-400 transition-colors duration-200">
                  ...
                  <label htmlFor="new-images-upload" className="cursor-pointer">
                    ...
                    <p className="text-gray-600 font-medium">Click to add new images</p>
                    ...
                    {imagePreviews.map((preview, index) => (
                      <div key={index} className="relative group">
                        <img
                          ...
                          alt={`New ${index + 1}`}
                          className="w-full h-24 object-cover rounded-xl border-2 border-green-400 group-hover:border-green-500 transition-colors duration-200"
                        />
                        <button
                          type="button"
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  {existingVideo ? "Replace Video" : "Add Video (Optional)"}
                </label>
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-green-400 transition-colors duration-200">
                  <input
                    type="file"
                    ...
                    id="new-video-upload"
                  />
                  <label htmlFor="new-video-upload" className="cursor-pointer">
                    <div className="text-4xl mb-2">🎥</div>
                    <p className="text-gray-600 font-medium">
                      {existingVideo ? "Click to replace video" : "Click to add video"}
                    </p>
                ...
                {videoPreview && (
                  <div className="mt-4 relative">
                    <video
                      src={videoPreview}
                      controls
                      className="w-full max-w-md mx-auto h-48 rounded-xl border-2 border-green-400"
                    />
                    <button
                      type="button"
...
export default EnhancedEditListingForm
